...
public class ContactListAdapter extends CursorAdapter{
    ...
    public void bindView(View view, Context context, Cursor cursor) {
    	try {
    	    ...
    	    if (cursor.getCount()>0)
    	    {
    	    	...
    	    	showSectionViewIfFirstItem((LinearLayout)view, loginValue, cursor.getPosition());
    	    }
	...
	public void showSectionViewIfFirstItem(View rowView, String name, int position){
